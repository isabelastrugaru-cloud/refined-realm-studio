    ...
    <div className="min-h-screen">
      ...
      >
        ...
        <div className="relative z-10 text-center text-white px-6 max-w-4xl mx-auto">
          ...
          <p className="font-inter text-xl md:text-2xl mb-8 text-white/90 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="animate-fade-in">
              ...
              <p className="font-inter text-lg text-muted-foreground mb-8 leading-relaxed">
                Cu peste 15 ani de experiență în crearea de spații exclusive, 
                LuxInterior Studio îmbină artă, funcționalitate și eleganță 
                pentru a realiza interioare care depășesc așteptările.
              </p>
            ...
            <div className="grid grid-cols-2 gap-4 animate-scale-in">
              <div className="space-y-4">
                <img 
                  src={luxuryBedroom} 
                  alt="Interior design luxury bedroom" 
                  className="w-full h-64 object-cover rounded-lg shadow-subtle hover:shadow-luxury transition-all duration-500"
                />
                <img 
                  src={luxuryKitchen} 
                  alt="Luxury kitchen interior design" 
                  className="w-full h-48 object-cover rounded-lg shadow-subtle hover:shadow-luxury transition-all duration-500"
                />
              </div>
              <div className="mt-8">
                <img 
                  ...
                  className="w-full h-80 object-cover rounded-lg shadow-subtle hover:shadow-luxury transition-all duration-500"
                />
              </div>
            </div>
          </div>
      ...
      <section className="py-24 bg-gradient-hero">
        <div className="max-w-4xl mx-auto text-center px-6 lg:px-8">
          ...
          <p className="font-inter text-xl text-white/90 mb-10 animate-fade-in">
            Începe cu o consultație gratuită și descoperă cum putem<br />
            crea interiorul perfect pentru tine
          </p>
