  ...
  const content = {
    ro: {
      ...
      sections: [
        ...
        {
          title: '6. Contact',
          text: 'Pentru orice întrebări legate de politica de cookie-uri, ne puteți contacta la: {{email}}.'
        }
      ]
    },
    en: {
      ...
      sections: [
        ...
        {
          title: '6. Contact',
          text: 'For any questions about the cookie policy, you can contact us at: {{email}}.'
        }
      ]
    },
    es: {
      ...
      sections: [
        ...
        {
          title: '6. Contacto',
          text: 'Para cualquier pregunta sobre la política de cookies, puede contactarnos en: {{email}}.'
        }
      ]
    }
  };
